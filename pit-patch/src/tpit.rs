use std::{collections::{BTreeMap, BTreeSet}, iter::once, mem::{replace, take}};

use anyhow::Context;
use pit_core::{Arg, ResTy};
use waffle::{util::new_sig, Block, BlockTarget, Export, ExportKind, Func, FuncDecl, FunctionBody, ImportKind, Module, Operator, SignatureData, Table, TableData, Type, Value};
use waffle_ast::{add_op, results_ref_2};

use crate::{get_interfaces, util::{talloc, tfree, to_waffle_sig, waffle_funcs}};
